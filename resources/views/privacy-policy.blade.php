  ...
  <div class="uk-card uk-card-default uk-card-body uk-margin-bottom">
      <div class="uk-child-width-1-1@m" uk-grid>
        <div class="">
          ...
          <p>1. WHO ARE WE?
          This website <a href="https://www.payrchat.com" class="uk-link-primary" target="_blank">(“payrchat.com”)</a> is operated by payrchat authority, the Bangladeshi top social media site registered in Bangladesh. You can contact us as indicated under the “Contact” section in the main navigation.
          The data controller responsible for your personal data is <a href="https://www.payrchat.com" class="uk-link-primary" target="_blank">payrchat.com</a> with whom you contract as a customer, member.<br/><br/>
          2. WHAT IS THIS PRIVACY POLICY IS FOR?
          This privacy policy <a href="https://www.payrchat.com" class="uk-link-primary" target="_blank">(“payrchat.com”)</a> applies to personal data that we collect from you as a user of this Site or as a partner applicant, job applicant, member, subscriber, or customer. It provides information on what personal data we collect, why we collect the personal data, how it is used and the lawful basis on which your personal data is processed, and what your rights are under the applicable data protection and privacy laws, including the General Data Protection Regulation of Bangladesh.<br/><br/>
          ...
          As necessary for certain legitimate business interests, which include the following:<br/><br/>
          ...
          As used in this Privacy Policy, “legitimate interests” means the interests of <a href="https://www.payrchat.com" class="uk-link-primary" target="_blank">payrchat.com</a> in conducting and managing our organization. When we process your personal data for our legitimate interests, we make sure to consider and balance any potential impact on you, and your rights under data protection laws.<br/><br/>
          5. DISCLAIMER:
          We share your personal data with third parties in the following situations:
          Service Providers: payrchat, like many businesses, sometimes hires selected third parties who act on our behalf to support our operations, such as <br/>
              (i) card processing or payment services (Payment Information),<br/>
              (ii) credit reference agencies to protect against possible fraud, <br/>
              (iii) IT suppliers and contractors (e.g. data hosting providers or delivery partners) as necessary to provide IT support and enable us to provide customer or members services and other goods/services available on this Site or to members, <br/>
              (iv) web analytics providers, <br/>
              (v) providers of digital advertising services and <br/>
              (vi) providers of CRM, marketing and sales software solutions. Pursuant to our instructions, these parties may access, process or store your personal data in the course of performing their duties to us and solely in order to perform the services we have hired them to provide.</p>
        </div>
      </div>
  </div>
</div>
